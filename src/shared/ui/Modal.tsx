...
export const Modal = ({
	...
	return (
		<div
			className='fixed inset-0 z-50 flex items-center justify-center bg-gray-500/75 backdrop-blur-md transition-opacity duration-300 ease-in-out'
			onClick={handleBackdropClick}
			role='dialog'
			aria-labelledby='dialog-title'
			aria-modal='true'
		>
			<div className='relative w-full max-w-lg transform overflow-hidden rounded-lg bg-white shadow-xl transition-all duration-300 ease-in-out'>
