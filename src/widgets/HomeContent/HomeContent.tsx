...
export const HomeContent = () => {
  ...
  useEffect(() => {
    console.log('Favorite Movies:', favoritesStore.favorites)
  }, [favoritesStore.favorites])

  const handleFavoriteClick = (movie: Movie) => {
    console.log('Favorite clicked for movie:', movie.name, 'isFavorited:', favoritesStore.isFavorite(movie.id))
  ...
  const handleConfirmFavorite = () => {
    if (selectedMovie) {
      if (isAddingToFavorites) {
        console.log('Adding to favorites:', selectedMovie.name)
        favoritesStore.addFavorite(selectedMovie)
      } else {
        console.log('Removing from favorites:', selectedMovie.name)
